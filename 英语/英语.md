...
- ### **Parts of  Speech**
  ...
  >
  >     | **助动词** | 含义              | **现在时** | **过去时** | **等价替换形式** |
  >     | :--------: | ----------------- | :--------: | :--------: | :--------------: |
  >     |    can     | 能力/许可         |    can     |   could    |    be able to    |
  >     |   could    | 委婉请求/过去能力 |     -      |     -      | was/were able to |
  >     |    may     | 许可/可能性       |    may     |   might    |  be allowed to   |
  >     |   might    | 较小可能性        |     -      |     -      |        -         |
  >     |   shall    | 建议/未来（正式） |   shall    |   should   |        -         |
  >     |   should   | 建议/义务         |     -      |     -      |     ought to     |
  >     |    will    | 意愿/未来         |    will    |   would    |   be going to    |
  >     |   would    | 委婉请求/过去习惯 |     -      |     -      |     used to      |
  >     |    must    | 必须/肯定推测     |    must    |     -      |     have to      |
  >
  >     ![image-20250405203352093](assets/image-20250405203352093.png) 
  >
...
>
> - 状语从句：从属连词 + 主语 + 谓语，修饰主句的动词、形容词或整个句子，时间、条件、原因等逻辑关系
>
...
>   2. I was reading **while** she was cooking.
>   3. You can sit **wherever** you like
>   4. **Since** you are busy, I will do it myself. 
